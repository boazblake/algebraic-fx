...
export interface Effect<Env = unknown, Msg = unknown> {
    run: (env: Env, dispatch: Dispatch<Msg>) => void | Promise<void> | (() => void) | Promise<() => void>;
}
/**
 ...
 * ```
 */
export declare const fx: <Env, Msg, Ret extends void | (() => void) = void | (() => void)>(run: (env: Env, dispatch: Dispatch<Msg>) => Ret) => Effect<Env, Msg>;
/**
 ...
 */
export type RawEffect<E> = IO<void> | Reader<E, IO<void>> | Effect<E, any> | IOEffect | ReaderEffect<E>;
/**
