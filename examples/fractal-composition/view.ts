import { div, h1, pre, section } from "./renderer";
...
export const view = (m: Model, dispatch: (msg: Msg) => void) =>
  div({ className: "min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-4 sm:p-6 md:p-8" }, [
    ...
    div(
      ...
      [
        h1({ className: "text-lg font-semibold p-4 text-emerald-400 bg-gray-800 border-b border-gray-700" }, "Full App State"),
        pre(
          {
            className:
